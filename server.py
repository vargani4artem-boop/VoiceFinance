...
def init_db():
    ...
    if force_reset:
        ...
        real_txs = [
            ...
            # Expenses
            ('expense', 70.0, 'USD', 'кафе', '70 дол кафе', '70 дол кафе', '2026-08-14', now_str),
            ('expense', 75.0, 'USD', 'бензин', '75 бенз', '75 бенз', '2026-08-15', now_str),
            ('expense', 17.0, 'USD', 'кафе', '17 кафе', '17 кафе', '2026-08-15', now_str),
            ('expense', 22.0, 'USD', 'витамины', '- 22 витамины', '- 22 витамины', '2026-08-16', now_str),
            ('expense', 529.0, 'USD', 'травориум', 'Зарегистрирую 529 долларов на членство в Травориум.', 'Зарегистрирую 529 долларов на членство в Травориум.', '2026-08-16', now_str),
            ('expense', 67.0, 'USD', 'кафе', '67, не сем', '67, не сем', '2026-08-16', now_str),
            ('expense', 112.0, 'USD', 'бензин', '112 дол бенз запиши', '112 дол бенз запиши', '2026-08-16', now_str),
            ('expense', 21.0, 'USD', 'прочее', 'Да нет, 21 dollar расходы на мороженное', 'Да нет, 21 dollar расходы на мороженное', '2026-08-16', now_str),
            ('expense', 14.0, 'USD', 'кафе', '14 дол кафе', '14 дол кафе', '2026-08-17', now_str),
            ('expense', 25.0, 'USD', 'продукты', 'Продукты', 'Продукты', '2026-08-17', now_str),
            ('expense', 25.0, 'USD', 'прочее', 'Занеси расход 25', 'Занеси расход 25', '2026-08-17', now_str),
            ('expense', 125.0, 'USD', 'бензин', '125 долларов на бензин', '125 долларов на бензин и 100 долларов на консультацию бухгалтера', '2026-08-17', now_str),
