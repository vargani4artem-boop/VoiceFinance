        ...
        if parsed.path == '/api/transactions':
            ...
            try:
                ...
                cursor.execute(
                    ...
                    "VALUES ('2026-08-15', 'income', 3456.72, 'зарплата', 'Доход за август (по данным банка)', 'CAD', '2026-08-15T12:00:00')"
                )
                ...
                rows = [(d, 'expense', amt, 'CAD', cat, desc, d + 'T12:00:00') for d, amt, cat, desc in aug_list]
                cursor.executemany(
