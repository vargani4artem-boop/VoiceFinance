    ...
    def do_GET(self):
        ...
        if parsed.path == '/api/transactions':
            ...
            try:
                ...
                # 2. Insert August income
                cursor.execute(
                    "INSERT INTO transactions (date, type, amount, category, description, currency) "
                    "VALUES ('2026-08-15', 'income', 3456.72, 'зарплата', 'Доход за август (по данным банка)', 'CAD')"
                )
                
                # 3. Insert all August expenses
                aug_list = [('2026-08-29', 241.73, 'жилье', 'Flag Accommodations'), ('2026-08-29', 50.7, 'покупки', 'Amazon'), ('2026-08-29', 12.05, 'кафе', 'Tim Hortons'), ('2026-08-28', 85.2, 'авто', 'Foothills Group Inc'), ('2026-08-28', 12.4, 'кафе', 'Tim Hortons'), ('2026-08-27', 64.56, 'проценты', 'Finance Charge'), ('2026-08-27', 7.34, 'кафе', 'Tim Hortons'), ('2026-08-26', 818.33, 'путешествия', 'American Airlines'), ('2026-08-26', 130.47, 'связь', 'Fido'), ('2026-08-26', 14.26, 'продукты', 'Sobeys'), ('2026-08-26', 6.18, 'кафе', 'Dairy Queen'), ('2026-08-25', 33.07, 'продукты', 'Sobeys'), ('2026-08-25', 109.46, 'бензин', 'Calgary Co-Op Gas'), ('2026-08-25', 6.06, 'бензин', 'Petro-Canada'), ('2026-08-25', 52.49, 'авто', 'Mint Smartwash'), ('2026-08-24', 70.91, 'продукты', 'Sobeys'), ('2026-08-24', 16.31, 'кафе', "Al's Chimney Cakes"), ('2026-08-24', 57.27, 'покупки', 'Shawnessy'), ('2026-08-24', 70.71, 'жилье', 'Flag Accommodations'), ('2026-08-24', 300.0, 'переводы', 'Global Money'), ('2026-08-23', 99.19, 'бензин', 'Shell'), ('2026-08-23', 40.2, 'здоровье', 'Shoppers Drug Mart'), ('2026-08-23', 5.25, 'авто', 'Calgary Airport Exit Toll'), ('2026-08-22', 156.92, 'продукты', 'Sobeys'), ('2026-08-22', 7.25, 'кафе', 'Good Earth Coffeehouse'), ('2026-08-22', 55.73, 'продукты', 'Sobeys'), ('2026-08-22', 125.99, 'покупки', 'Amazon'), ('2026-08-22', 22.75, 'продукты', 'Sobeys'), ('2026-08-21', 50.0, 'инвестиции', 'Internet Interactive Brokers Canad'), ('2026-08-21', 1054.6, 'погашение укр', 'Intl Visa Monobank Uah'), ('2026-08-21', 124.15, 'проценты', 'Finance Charge'), ('2026-08-20', 53.52, 'подписки', 'Apple'), ('2026-08-19', 17.92, 'кафе', 'Tim Hortons'), ('2026-08-18', 82.71, 'продукты', 'Sobeys'), ('2026-08-17', 21.0, 'кафе', 'Village Ice Cream'), ('2026-08-17', 125.57, 'бензин', 'Calgary Co-Op Gas'), ('2026-08-17', 105.0, 'налоги', 'Tax Calgary Downtown'), ('2026-08-17', 26.11, 'продукты', 'Sobeys'), ('2026-08-17', 22.04, 'покупки', 'Amazon'), ('2026-08-17', 13.94, 'кафе', 'Tim Hortons'), ('2026-08-17', 23.09, 'покупки', 'Amazon'), ('2026-08-16', 528.72, 'подписки', 'Travorium'), ('2026-08-15', 16.0, 'продукты', 'Italian Centre Shop'), ('2026-08-15', 74.63, 'бензин', 'Shell'), ('2026-08-14', 20.0, 'переводы', 'E-Transfer Alya'), ('2026-08-14', 6.6, 'кафе', 'Tim Hortons'), ('2026-08-14', 38.75, 'развлечения', 'Landmark Web Ticketing'), ('2026-08-14', 68.72, 'кафе', 'A&W'), ('2026-08-13', 91.39, 'продукты', 'Sobeys'), ('2026-08-13', 66.68, 'кафе', 'Peters Drive In'), ('2026-08-13', 150.0, 'переводы', 'E-Transfer Tomaidh'), ('2026-08-13', 33.59, 'покупки', 'Amazon'), ('2026-08-12', 42.0, 'услуги', 'Magic Printing'), ('2026-08-12', 23.39, 'продукты', 'Italian Centre Shop'), ('2026-08-12', 10.49, 'подписки', 'Amazon Prime Membership'), ('2026-08-11', 50.0, 'бензин', 'Petro-Canada'), ('2026-08-11', 15.0, 'обучение', 'Grantcardone'), ('2026-08-11', 10.25, 'кафе', 'Tim Hortons'), ('2026-08-10', 160.0, 'переводы', 'E-Transfer Maminsmakolik'), ('2026-08-10', 6.59, 'продукты', "Lina's Italian Mercato"), ('2026-08-10', 27.66, 'продукты', "Lina's Italian Mercato"), ('2026-08-10', 7.43, 'кафе', 'Analog Southcentre'), ('2026-08-10', 68.24, 'покупки', 'Capz'), ('2026-08-10', 68.75, 'услуги', 'Vitalii Vashchenko'), ('2026-08-10', 29.35, 'покупки', 'Shawnessy'), ('2026-08-10', 33.34, 'здоровье', 'Viva Dental'), ('2026-08-10', 58.0, 'услуги', 'Shepard Landfill'), ('2026-08-10', 50.34, 'прочее', 'Intl Assc Scientologists'), ('2026-08-09', 20.0, 'переводы', 'E-Transfer Alya'), ('2026-08-09', 11.69, 'продукты', '7-Eleven'), ('2026-08-09', 134.02, 'покупки', 'Winners'), ('2026-08-09', 35.68, 'покупки', 'Amazon'), ('2026-08-09', 43.14, 'услуги', 'Flag Services'), ('2026-08-08', 471.68, 'продукты', 'Sobeys'), ('2026-08-08', 16.29, 'кафе', 'Tim Hortons'), ('2026-08-08', 28.5, 'услуги', 'Shepard Landfill'), ('2026-08-08', 52.45, 'покупки', 'Apple Store'), ('2026-08-08', 33.44, 'кафе', 'Jugo Juice'), ('2026-08-08', 31.74, 'прочее', 'Ca'), ('2026-08-07', 50.65, 'продукты', 'Sobeys'), ('2026-08-07', 29.39, 'покупки', 'Amazon'), ('2026-08-07', 26.03, 'покупки', 'Amazon'), ('2026-08-07', 10.25, 'кафе', 'Tim Hortons'), ('2026-08-07', 23.51, 'покупки', 'Amazon'), ('2026-08-07', 119.34, 'бензин', 'Petro-Canada'), ('2026-08-06', 54.02, 'продукты', 'Sobeys'), ('2026-08-06', 125.08, 'бензин', 'Petro-Canada'), ('2026-08-06', 16.79, 'покупки', 'Amazon'), ('2026-08-06', 28.34, 'покупки', 'Amazon'), ('2026-08-05', 11.48, 'кафе', 'Amato Gelato 17th Ave'), ('2026-08-05', 20.0, 'переводы', 'E-Transfer Alya'), ('2026-08-05', 150.0, 'переводы', 'E-Transfer Tomaidh'), ('2026-08-05', 16.95, 'банк', 'Service Charge'), ('2026-08-05', 16.95, 'банк', 'Service Charge'), ('2026-08-04', 17.95, 'проценты', 'Finance Charge'), ('2026-08-03', 200.0, 'переводы', 'Global Money'), ('2026-08-03', 29.16, 'продукты', 'Italian Centre Shop'), ('2026-08-03', 95.76, 'здоровье', 'Shoppers Drug Mart'), ('2026-08-02', 118.22, 'бензин', 'Esso Gas Station'), ('2026-08-02', 5.51, 'кафе', '7-Eleven'), ('2026-08-02', 13.64, 'кафе', '7-Eleven'), ('2026-08-01', 11.32, 'кафе', 'Tim Hortons'), ('2026-08-01', 26.93, 'продукты', '7-Eleven'), ('2026-08-01', 14.65, 'кафе', 'Village Ice Cream')]
                rows = [(d, 'expense', amt, 'CAD', cat, desc) for d, amt, cat, desc in aug_list]
                cursor.executemany(
                    "INSERT INTO transactions (date, type, amount, currency, category, description) "
                    "VALUES (?, ?, ?, ?, ?, ?)",
                    rows
                )
                conn.commit()
                ...
                import persistence
                persistence.backup_db()
                self.send_json({"success": True, "message": "August fully synchronized with bank statement."})
            except Exception as e:
                if conn:
                    try:
                        conn.close()
